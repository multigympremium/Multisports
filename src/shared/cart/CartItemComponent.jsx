          ...
          <div>
            <div className="flex mb-4 relative  rounded-md p-2">
              ...
              <div className="flex w-full ml-4 ">
                <div>
                  <div className="flex flex-col ">
                    ...
                    <span className=" text-gray-500">Unit price : <span className="text-xl font-bold">৳</span>{item.price}</span>
                    <div
              ...
              <div className="mb-2 flex flex-col justify-end">
                <p className="font-semibold text-lg px-2 flex items-end gap-1 ml-auto"><span className="text-2xl font-bold">৳ </span>{item?.price * quantity}</p>
              </div>
              <button
