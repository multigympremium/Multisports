...
import CreateNewArrivalBannerForm from "./forms/CreateNewArrivalBannerForm";
import UpdateNewArrivalBannerForm from "./forms/UpdateNewArrivalBannerForm";
import useAxiosSecure from "../../../../Hook/useAxiosSecure";
import DeleteButton from "../../../../components library/DeleteButton";
import EditButton from "../../../../components library/EditButton";
import Mpagination from "../../../../shared/Mpagination";
import useGetAllNewArrivalBanner from "../../../../Hook/GetDataHook/useGetAllNewArrivalBanner";
...
const NewArrivalBanner = () => {
  ...
  const banners = useGetAllNewArrivalBanner({
    ...
    <div className="p-6 pt-0">
      <div className="">
        <div className="flex justify-between mb-9 items-center">
          <h1 className="text-2xl md:text-3xl font-semibold ">New Arrival Banner List</h1>
          <div>
            <button
      ...
      <BgBlurModal isShowModal={showModal} setIsShowModal={setShowModal}>
        <CreateNewArrivalBannerForm setIsShow={setShowModal} />
      </BgBlurModal>
      <BgBlurModal isShowModal={isEdit} setIsShowModal={setIsEdit}>
        <UpdateNewArrivalBannerForm
          targetId={targetId}
          isShow={isEdit}
          setIsShow={setIsEdit}
        />
