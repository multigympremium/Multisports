...
import CreatePopularBannerForm from "./forms/CreatePopularBannerForm";
import UpdatePopularBannerForm from "./forms/UpdatePopularBannerForm";
import useAxiosSecure from "../../../../Hook/useAxiosSecure";
import DeleteButton from "../../../../components library/DeleteButton";
import EditButton from "../../../../components library/EditButton";
import Mpagination from "../../../../shared/Mpagination";
import useGetAllPopularBanner from "../../../../Hook/GetDataHook/useGetAllPopularBanner";
...
const PopularBanner = () => {
  ...
  const banners = useGetAllPopularBanner({
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            const res = await axiosSecure.delete(`/popular-banners/${id}`);
            console.log(res, "res");
      ...
      console.log(error, "error");
      toast.error("Error deleting Popular!");
    }
    console.log(`Delete Popular with ID: ${id}`);
  };
    ...
    <div className="p-6 pt-0">
      <div className="">
        <div className="flex justify-between mb-9 items-center">
          <h1 className="text-3xl font-semibold ">Popular Banner List</h1>
          <div>
            <button
      ...
      <BgBlurModal isShowModal={showModal} setIsShowModal={setShowModal}>
        <CreatePopularBannerForm setIsShow={setShowModal} />
      </BgBlurModal>
      <BgBlurModal isShowModal={isEdit} setIsShowModal={setIsEdit}>
        <UpdatePopularBannerForm
          targetId={targetId}
          isShow={isEdit}
          setIsShow={setIsEdit}
        />
