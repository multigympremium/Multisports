...
import CreateBagBannerForm from "./forms/CreateBagBannerForm";
import UpdateBagBannerForm from "./forms/UpdateBagBannerForm";
import useGetAllBagBanners from "../../../../Hook/GetDataHook/useGetAllBagBanners";
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            const res = await axiosSecure.delete(`/bag-banners/${id}`);
    ...
    <div className="p-6 pt-0">
      <div className="">
        <div className="flex justify-between mb-9 items-center">
          <h1 className="text-2xl md:text-3xl font-semibold ">Bag Banner List</h1>
          <div>
            <button
      ...
      <BgBlurModal isShowModal={showModal} setIsShowModal={setShowModal}>
        <CreateBagBannerForm setIsShow={setShowModal} />
      </BgBlurModal>
