  ...
  return (
    <div className="p-6 pt-0">
      <div className="flex items-center justify-between  mb-9">
        <h1 className="md:text-3xl text-2xl font-semibold md:border-l-[5px] border-blue-400 pl-3">System Users List</h1>
              ...
              systemUsers.map((user, index) => (
                <tr key={user.id} className="bg-white text-gray-600 font-[500] text-left">
                  ...
                  <td className="p-3 pl-5 border border-gray-100">
                    <span
                      className={`capitalize w-full inline-block px-3 py-1 rounded-full text-sm font-medium ${user.role === "admin"
