    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 md:gap-4 lg:gap-5 md:grid-cols-2">
        ...
        <div>
          ...
          <input type="text" {...register("google_map_link")} className="customInput" />
          {errors.google_map_link && <span className="text-red-600 text-sm">{errors.google_map_link.message}</span>}
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">Play Store Link</label>
          <input type="text" {...register("play_store_link")} className="customInput" />
          {errors.play_store_link && <span className="text-red-600 text-sm">{errors.play_store_link.message}</span>}
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">App Store Link</label>
          <input type="text" {...register("app_store_link")} className="customInput" />
          {errors.app_store_link && <span className="text-red-600 text-sm">{errors.app_store_link.message}</span>}
        </div>

        {/* Official Details */}
        <div>
          <label className="block text-sm font-medium text-gray-700">Trade License No</label>
          <input type="text" {...register("trade_license")} className="customInput" />
          {errors.trade_license && <span className="text-red-600 text-sm">{errors.trade_license.message}</span>}
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">TIN No</label>
          <input type="text" {...register("tin_no")} className="customInput" />
        ...
        <div>
          ...
          <input type="text" {...register("bin_no")} className="customInput" />
        ...
        <div>
          ...
          <input type="text" {...register("footer_copyright")} className="customInput" />
          {errors.footer_copyright && <span className="text-red-600 text-sm">{errors.footer_copyright.message}</span>}
        </div>
      </div>
