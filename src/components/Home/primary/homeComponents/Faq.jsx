            ...
            <Container>
                <div className="max-w-screen-lg mx-auto my-5 md:my-8 lg:my-16 space-y-10">
                    ...
                    <div className="flex flex-col-reverse md:flex-row items-center ">
                        ...
                        <div className="">
                            <img height={500} width={500} src="https://i.ibb.co/cCD1bnP/grey-removebg-preview.png" alt="" className="hidden md:flex " />
                            <img height={500} width={500}  src="https://i.ibb.co/dD4G85m/gb.png" alt="" className="md:hidden" />
                        </div>
                    </div>
                </div>
            </Container>
